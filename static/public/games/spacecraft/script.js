...
!function(t) {
    ...
    class e {
        ...
        set(t, s, i) {
            return t instanceof e ? (this.x = t.x,
                                     this.y = t.y,
                                     this.z = t.z,
                                     this) : ("number" == typeof t && (this.x = t),
                                ...
                                scale(t) {
                                    return this.x *= t instanceof e ? t.x : t,
                            ...
                            class i {
                                ...
                                multiply(t) {
                                    ...
                                    , R = t[14]
                                    , N = t[15];
                                    return this.data = [s * x + i * b + n * C + r * M, s * w + i * k + n * A + r * F, s * y + i * S + n * z + r * R, s * T + i * E + n * D + r * N, a * x + o * b + h * C + c * M, a * w + o * k + h * A + c * F, a * y + o * S + h * z + c * R, a * T + o * E + h * D + c * N, l * x + u * b + m * C + d * M, l * w + u * k + m * A + d * F, l * y + u * S + m * z + d * R, l * T + u * E + m * D + d * N, f * x + p * b + g * C + v * M, f * w + p * k + g * A + v * F, f * y + p * S + g * z + v * R, f * T + p * E + g * D + v * N],
                                    this
                                }
                                scale(t) {
                                ...
                                perspective(t, e, s, i) {
                                    ...
                                    , r = 1 / (s - i);
                                    return this.multiply([n / e, 0, 0, 0, 0, n, 0, 0, 0, 0, (s + i) * r, -1, 0, 0, s * i * r * 2, 0])
                                }
                                invert() {
                                    const t = this.data
                                    , e = t[0]
                                    ...
                                    if (!f)
                                        return null;
                                    const p = 1 / f;
                                    return new s([u * p, (-l * i + n * c) * p, (o * i - n * a) * p, m * p, (l * e - n * h) * p, (-o * e + n * r) * p, d * p, (-c * e + i * h) * p, (a * e - i * r) * p])
                                }
                            }
                            t.Mat4 = i;
                            class n {
                            ...
                            t.Sphere = class extends n {
                                intersect(t) {
                                    ...
                                    return n < r && (e = i.sub(s).normalize().scale(r - n)),
                                    e
                                }
                            }
                            ;
                            t.Box = class extends n {
                                intersect(t) {
                                    ...
                                    , n = t.getTranslate()
                                    , r = t.getScale().max()
                                    , a = new e(Math.max(s.x - i.x, Math.min(n.x, s.x + i.x)),Math.max(s.y - i.y, Math.min(n.y, s.y + i.y)),Math.max(s.z - i.z, Math.min(n.z, s.z + i.z)))
                                    , o = a.distance(n)
                                    , h = null;
                                    return o < r && (h = n.sub(a).normalize().scale(r - o)),
                                    h
                                }
                            }
                            ;
                            class r {
                                ...
                                matrix(e) {
                                    return (e = e || new i).scale(this.scale).rotate(this.rotate.clone().scale(t.RAD_SCALE)).translate(this.translate),
                                    this.parent ? this.parent.matrix(e) : e
                                }
                            }
                            t.Transform = r;
                            t.Camera = class {
                                constructor(t=1, s=45, i=.1, n=100) {
                                    this.rotate = new e,
                                    this.position = new e,
                                    this.fov = s,
                                    this.aspect = t,
                            ...
                            t.Mesh = class {
                                constructor(e, s, i=[], n=0, r=360) {
                                    if (s < 2)
                                        return;
                                    i.length < 2 && (i = this.sphere(i.length > 0 ? i[0] + 2 : Math.ceil(s / 2) + 1));
                            ...
                            t.Shader = class {
                                constructor(t, e, s) {
                                    ...
                                    t.linkProgram(i),
                                    t.getProgramParameter(i, t.LINK_STATUS) || (console.log(t.getProgramInfoLog(i)),
                                                                                t.deleteProgram(i))
                                }
                                create(t, e) {
                                    const s = this.gl
                                    ...
                                    s.compileShader(i),
                                    s.getShaderParameter(i, s.COMPILE_STATUS) || console.log(s.getShaderInfoLog(i)),
                                    i
                                }
                                attrib(t, e, s) {
                                    const i = this.gl;
                        ...
                        function(t) {
                            ...
                            t.Sound = class {
                                constructor(t, e, s) {
                                    this.type = t,
                                    this.curve = Float32Array.from(e),
                                    this.length = s
                                }
                                time(t) {
                        ...
                        ;
                        function c(t) {
                            return t in r || (r[t] = n.createGain(),
                                              r[t].connect(n.destination)),
                            r[t]
                        }
                        t.Channel = class {
                            constructor(t, e, n) {
                                ...
                                if (r.length > 1) {
                                    ...
                                    for (let t = 0; t < r.length; t++)
                                        e += t % 2 ? ("," + r[t - 1]).repeat(parseInt(r[t]) - 1) : (e ? "," : "") + r[t]
                                }
                                e.split(",").forEach(t=>{
                                    let e = t.match(/^(\d+)/)
                                    , r = t.match(/([a-z]+\d+)/g);
                        ...
                        t.init = async function() {
                            ...
                            for (let e = -57; e < 50; e++)
                                i.push(440 * Math.pow(t, e));
                            o = n.createBuffer(1, 2 * e, e),
                            h = o.getChannelData(0);
                            for (let t = 0; t < 2 * e; t++)
                                h[t] = 2 * Math.random() - 1
                        }
                        ,
                    ...
                    function(t) {
                        t.Enemy = class extends T3D.Item {
                            ...
                            update(t, e) {
                                if (!this.active)
                                    return;
                                if (this.stroke += (this.explode - this.stroke) / 25,
                                    this.stroke)
                                    return;
                            ...
                            intersect(e) {
                                if (this.active && !this.explode && !e.explode && this.collider.intersect(e.collider)) {
                                    if (e.speedTime)
                                        return this.explode = 7,
                                    void t.Event.trigger("hit", e);
                                    e.explode = 7,
                                    t.Event.trigger("exp", e)
                                }
                            }
                        }
                    }(Game || (Game = {})),
                    function(t) {
                        class e {
                            ...
                            static trigger(t, s) {
                                ...
                                t in e.listener && e.listener[t].forEach(e=>{
                                    e(t, s)
                                }
                                )
                            }
                    ...
                    function(t) {
                        t.Hero = class extends T3D.Item {
                            ...
                            jump() {
                                this.collide && (this.acc = .03,
                                                 t.Event.trigger("jump", this))
                            }
                            boost() {
                                this.speedTime = 75,
                                t.Event.trigger("move", this)
                            ...
                            update() {
                                ...
                                , s = this.scale
                                , i = this.transform.rotate
                                , n = (this.speedTime ? .13 : .08) + Math.min(this.distance / 15e3, .04);
                                this.speed.z += ((this.active ? n : 0) - this.speed.z) / 20,
                                this.speedTime -= this.speedTime > 0 ? 1 : 0,
                                this.color = this.magnetTime > 100 || this.magnetTime % 20 > 10 ? t.COLOR.PINK : t.COLOR.WHITE,
                                ...
                                this.active && !this.stroke && (this.acc -= this.acc > -.012 ? .003 : 0,
                                                                i.z = 90 + 25 * (e.x - this.x),
                                                                i.y = (i.y + 100 * this.speed.z) % 360,
                                                                this.speed.y += this.acc,
                                                                this.speed.y < -.25 && (this.speed.y = -.25),
                                                                e.x += (this.x - e.x) / 7,
                                                                e.y += this.speed.y,
                                                                e.z -= e.z / 30,
                    ...
                    function(t) {
                        ...
                        t.Menu = class {
                            constructor() {
                                ...
                                this.shop = !0,
                                this.active = !0,
                                this.storage = s && "object" == typeof s && "shop"in s ? s : {
                                    score: 0,
                                    token: 0,
                                    level: 0,
                                    shop: [0]
                            ...
                            init() {
                                ...
                                switch (i = Math.ceil(e / 4),
                                        e % 4) {
                                case 1:
                                    s.push(i < 8 ? new t.Task("planet",i) : new t.Task("hit",i,!0));
                                    break;
                                case 2:
                                    s.push(i % 2 == 1 ? new t.Task("fence",5 * i) : new t.Task("fence",3 * i,!0));
                                    break;
                                case 3:
                                    s.push(i % 2 == 1 ? new t.Task("enemy",3 * i) : new t.Task("enemy",2 * i,!0));
                                    break;
                                default:
                            ...
                            input(e) {
                                ...
                                play() {
                                    "PLAY" == this.btn.textContent ? (this.stats = {},
                                                                      t.Event.trigger("start")) : "" == this.btn.className && (this.storage.token -= this.heroes[this.selected].price,
                                                                  ...
                                                                  hero() {
                                                                    ...
                                                                    this.info.item(1).textContent = s ? `${t} / ${e.price} ₮` : "",
                                                                ...
                                                                score(t) {
                                                                    ...
                                                                    e < h ? (s.textContent = "NEW HIGH SCORE",
                                                                             this.storage.score = h) : s.textContent = "SCORE",
                                                                    this.storage.token += o,
                                                                    this.store(),
                                                                    this.active = !0,
                                                                    this.body.className = "end"
                                                                    console.log(i.item(6).textContent);

                                                                    data.score = Number(i.item(6).textContent)

                                                                    if (o >= 75) {
                                                                        data.achievements.push(4)
                                                                    }

                                                                    if (this.storage.shop.length == 5) {
                                                                        data.achievements.push(5)
                                                                    }

                                                                    if (r == 7) {
                                                                        data.achievements.push(6)   
                                                                    }
                                                        ...
                                                        function(t) {
                                                            t.Platform = class extends T3D.Item {
                                                                update(t) {
                                                                    ...
                                                                    s && (e.z -= 11);
                                                                    let i = 1;
                                                                    return e.z < -8 ? i = e.z + 9 : e.z > 1 && (i = 2 - e.z),
                                                                ...
                                                                intersect(t, e=!1) {
                                                                    if (!t.active || t.stroke)
                                                                        return;
                                                                    let s, i = this.fence;
                                                                    return this.token.intersect(t),
                                                                    i.active && (s = i.collider.intersect(t.collider)) && (e && s.x && t.cancel(),
                                                                                                                           t.transform.translate.add(s),
                                                                                                                           t.speed.y += s.y),
                                                                    this.block.active ? ((s = this.block.collider.intersect(t.collider)) && (e && s.x && t.cancel(),
                                                                                                                                             t.transform.translate.add(s),
                                                                                                                                             t.speed.y += s.y),
                                                                    s) : void 0
                                                                }
                                                            ...
                                                            t.Scene = class extends T3D.Item {
                                                                ...
                                                                init() {
                                                                    ...
                                                                    for (let e = -9; e < 2; e++)
                                                                        ...
                                                                        for (this.planet = this.planets.length - 1,
                                                                             t = 0; t < this.planets.length; t++)
                                                                            this.planets.item(t).className = ""
                                                                    }
                                                                    next() {
                                                                        this.planet > 0 && (this.planets.item(this.planet--).className = "hide",
                                                                    ...
                                                                    updateRow(t) {
                                                                        this.row -= t,
                                                                        this.row <= -.5 && (this.row += 11),
                                                                        this.index = 3 * Math.round(this.row) + Math.round(this.hero.transform.translate.x) + 1
                                                                    }
                                                                    getIndex(t=0) {
                                                            ...
                                                            function(t) {
                                                                ...
                                                                t.Task = class {
                                                                    ...
                                                                    toString() {
                                                                        ...
                                                                        return "planet" == t ? n = s[this.target - 1] : (this.target > 1 && (i += "s"),
                                                            ...
                                                            function(t) {
                                                                ...
                                                                t.Token = class extends T3D.Item {
                                                                    ...
                                                                    update() {
                                                                        ...
                                                                        t.y = (t.y + 1.5) % 360,
                                                                        this.big ? (i.set(.7, .15, .7),
                                                                                    this.color = s) : (i.set(.5, .1, .5),
                                                                                    this.color = e)
                                                                                }
                                                                                intersect(t) {
                                                                                    ...
                                                                                    if (this.active && this.collider.intersect(e)) {
                                                                                        ...
                                                                                        if (e.distance(t.transform.translate) < .5)
                                                                                            return this.active = !1,
                                                                                        void (this.big ? t.magnetize() : t.coin());
                                                                                        this.speed += this.speed,
                                                                                        this.transform.translate.add(t.transform.translate.clone().sub(e).scale(this.speed))
                                                                                    }
                                                                                }
                                                                            }
                                                                        }(Game || (Game = {})),
                                                                        function(t) {
                                                                            ...
                                                                            let n, r = !1, a = e("#game"), o = new t.Menu, h = (new Date).getTime(), c = a.getContext("webgl"), l = new T3D.Vec3(5,15,7), u = new T3D.Camera(a.width / a.height), m = new T3D.Shader(c,"precision mediump float;attribute vec3 aPos, aNorm;uniform mat4 uWorld, uProj;uniform mat3 uInverse;uniform float uStroke;varying vec4 vPos;varying vec3 vNorm;void main(void) {vec3 pos = aPos + (aNorm * uStroke);vPos = uWorld * vec4(pos, 1.0);vNorm = uInverse * aNorm;gl_Position = uProj * vPos;}","precision mediump float;uniform mat4 uWorld;uniform vec4 uColor;uniform vec3 uLight;uniform float uLevels;varying vec4 vPos;varying vec3 vNorm;vec3 uAmbient = vec3(.2, .2, .2);vec3 uDiffuse = vec3(.8, .8, .8);vec3 uSpecular = vec3(.8, .8, .8);void main(void) {vec3 lightDir = normalize(uLight - vPos.xyz);vec3 normal = normalize(vNorm);vec3 eyeDir = normalize(-vPos.xyz);vec3 reflectionDir = reflect(-lightDir, normal);float specularWeight = 0.0;if (uColor.w > 0.0) { specularWeight = pow(max(dot(reflectionDir, eyeDir), 0.0), uColor.w); }float diffuseWeight = max(dot(normal, lightDir), 0.0);vec3 weight = uAmbient + uSpecular * specularWeight  + uDiffuse * diffuseWeight;vec3 color = uColor.xyz * weight;if (uLevels > 1.0) { color = floor(color * uLevels) * (1.0 / uLevels); }gl_FragColor = vec4(color, 1);}"), d = {
                                                                                hero: [new T3D.Mesh(c,10), new T3D.Mesh(c,10,[.5, .15, .5, .1, .5, -.1, .5, -.15]), new T3D.Mesh(c,10,[.2, .5, .48, .2, .5, .1, .2, .1, .2, -.1, .5, -.1, .48, -.2, .2, -.5]), new T3D.Mesh(c,10,[.3, .44, .43, .3, .45, .2, .49, .2, .5, .1, .45, .1, .45, -.1, .5, -.1, .49, -.2, .45, -.2, .43, -.3, .3, -.44])],
                                                                                block: new T3D.Mesh(c,4,[.55, .5, .65, .4, .65, -.4, .55, -.5]),
                                                                                fence: new T3D.Mesh(c,12,[.4, .5, .5, .4, .5, -.4, .4, -.5],40),
                                                                                token: new T3D.Mesh(c,9,[.45, .3, .45, .5, .5, .5, .5, -.5, .45, -.5, .45, -.3],30),
                                                                                enemy: new T3D.Mesh(c,6)
                                                                            }, f = new t.Hero(d.hero[0],t.COLOR.WHITE), p = new t.Scene(f,()=>{
                                                                                let e = new t.Platform
                                                                                , s = new T3D.Item(d.block,t.COLOR.BLUE,[, , , , 45])
                                                                                , i = new t.Enemy(d.enemy,t.COLOR.CYAN,[, 1, , , , , .7, .7, .7])
                                                                                , n = new t.Token(d.token,t.COLOR.YELLOW,[, 1, , 90, , , .5, .1, .5])
                                                                                , r = new T3D.Item(d.fence,t.COLOR.RED,[, 1.4, , , , , .8, 1, .8]);
                                                                                return s.collider = new T3D.Box(s.transform),
                                                                            ...
                                                                            ,new t.Map("311737173711|4111|5711|3111|211135012111|2111|301531513510|311119973111|5111111d|311120003115|551111dd|305130053051|3111139b3511|211130002115|401510004510"));
                                                                            function g() {
                                                                            ...
                                                                            function v(t, e=0) {
                                                                                if (t.childs.forEach(t=>{
                                                                                    ...
                                                                                    s && (c.cullFace(e > 0 ? c.FRONT : c.BACK),
                                                                                          c.useProgram(m.program),
                                                                                          m.attrib("aPos", t.mesh.verts, 3).attrib("aNorm", t.mesh.normals, 3).uniform("uWorld", u.transform(t.transform).data).uniform("uProj", u.perspective().data).uniform("uInverse", s.transpose().data).uniform("uColor", e ? [0, 0, 0, 1] : t.color).uniform("uLight", l.clone().sub(u.position).toArray()).uniform("uStroke", e + t.stroke).uniform("uLevels", e ? 0 : 5),
                                                                                ...
                                                                                function x() {
                                                                                    if (requestAnimationFrame(x),
                                                                                        ...
                                                                                        o.shop)
                                                                                        return f.mesh = d.hero[o.selected],
                                                                                    f.preview(),
                                                                                    v(f),
                                                                                    void v(f, .02);
                                                                                    ...
                                                                                    t.gain.setValueCurveAtTime(Float32Array.from([o.volume, 0]), e, .5),
                                                                                    n.stop(e + .5),
                                                                                    n = null
                                                                                }
                                                                            ...
                                                                            async function w() {
                                                                                ...
                                                                                await SFX.init(),
                                                                                await Promise.all([new SFX.Sound("custom",[5, 1, 0],1).render("exp", [220, 0], 1), new SFX.Sound("custom",[3, 1, 0],1).render("hit", [1760, 0], .3), new SFX.Sound("square",[.5, .1, 0],1).render("power", [440, 880, 440, 880, 440, 880, 440, 880], .3), new SFX.Sound("triangle",[.5, .1, 0],1).render("jump", [220, 880], .3), new SFX.Sound("square",[.2, .1, 0],.2).render("coin", [1760, 1760], .2), new SFX.Sound("custom",[.1, .5, 0],.3).render("move", [1760, 440], .3), SFX.render("music", [new SFX.Channel(new SFX.Sound("sawtooth",[1, .3],.2),"8a2,8a2,8b2,8c3|8|8g2,8g2,8a2,8b2|8|8e2,8e2,8f2,8g2|4|8g2,8g2,8a2,8b2|4|".repeat(4),1), new SFX.Channel(new SFX.Sound("sawtooth",[.5, .5],1),"1a3,1g3,2e3,4b3,4c4,1a3c3e3,1g3b3d4,2e3g3b3,4d3g3b3,4g3c4e4|1|" + "8a3,8a3e4,8a3d4,8a3e4|2|8g3,8g3d4,8g3c4,8g3d4|2|8e3,8e3a3,8e3b3,8e3a3,4g3b3,4g3c4|1|".repeat(2),4)])]),
                                                                            ...
                                                                            s(window, "load", async()=>{
                                                                                ...
                                                                                v(f),
                                                                                v(f, .02),
                                                                                e("link[rel=apple-touch-icon]").href = e("link[rel=icon]").href = a.toDataURL(),
                                                                                u.position.set(0, .5, 5),
                                                                                g(),
                                                                                function() {
                                                                                    let i = 0
                                                                                    , a = 0
                                                                                    ...
                                                                                    s(document, "touchmove", t=>{
                                                                                        if (t.preventDefault(),
                                                                                            ...
                                                                                            return;
                                                                                        let e = t.touches[0];
                                                                                        !h[39] && e.clientX - i > 15 ? (h[39] = !0,
                                                                                                                        p.input(39),
                                                                                                                        c = !1) : !h[37] && e.clientX - i < -15 ? (h[37] = !0,
                                                                                                                        p.input(37),
                                                                                                                        c = !1) : !h[40] && e.clientY - a > 15 ? (h[40] = !0,
                                                                                                                        p.input(40),
                                                                                                                        c = !1) : !h[38] && e.clientY - a < -15 && (h[38] = !0,
                                                                                                                        p.input(38),
                                                                                                                        c = !1)
                                                                                                                    }
                                                                                                                    , {
